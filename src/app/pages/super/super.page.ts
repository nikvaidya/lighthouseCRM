...
import {Platform, ModalController, PopoverController, Events, MenuController, NavController } from '@ionic/angular';
...
//     alert("fcm plugin start")
//     if (this.platform.is('android') || this.platform.is('ios')) {

//       alert("fcm plugin start in ios ")
