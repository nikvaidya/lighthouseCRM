...
@NgModule({
  ...
  entryComponents: [EntryListPage,UsersettingPage, PartylistPage,DynamicmodalPage,DeveloperModeLogPage,SettingPage,TextAreaPage,AppInfoPage,
  ...
  providers: [
    ...
    NativeGeocoder, BackgroundMode, MediaCapture, File, BatteryStatus,FileOpener,FCM,
    InAppBrowser, EmailComposer, FileTransfer, DocumentViewer, File, Base64, FileChooser, FilePath,
